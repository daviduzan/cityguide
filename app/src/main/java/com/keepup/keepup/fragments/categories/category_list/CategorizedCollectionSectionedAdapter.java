 ...
 */
class CategorizedCollectionSectionedAdapter extends SectionedRecyclerViewAdapter<RecyclerView.ViewHolder> {

    private OnItemClickListener mOnItemClickListener;
    private ArrayList<CollectionCategory> mCollectionCategories;

    CategorizedCollectionSectionedAdapter(ArrayList<CollectionCategory> collectionCategories, OnItemClickListener onItemClickListener) {
        mCollectionCategories = collectionCategories;
...
//        };
    ...
    public int getSectionCount() {
        return mCollectionCategories.size();
    }

    @Override
    public int getItemCount(int section) {
        return mCollectionCategories.get(section).getMembers().size();
    }

    @Override
    public void onBindHeaderViewHolder(RecyclerView.ViewHolder holder, int section) {
        // Setup header view.
        ((CategorizedCollectionViewHolder) holder).bindHeaderData(section, mCollectionCategories.get(section).getTitle());
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int section, int relativePosition, int absolutePosition) {
        ...
        String member = mCollectionCategories.get(section).getMembers().get(relativePosition);
    ...
    public void setCategorizedCollectionData(ArrayList<CollectionCategory> data) {
        mCollectionCategories = data;
